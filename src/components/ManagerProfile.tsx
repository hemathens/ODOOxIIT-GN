...
export function ManagerProfile({ managerName, onLogout }: ManagerProfileProps) {
  const [profileData, setProfileData] = useState<ManagerProfileData>(() => {
    ...
    return savedProfile ? JSON.parse(savedProfile) : {
      firstName: managerName.split(" ")[0] || "Manager",
      lastName: managerName.split(" ")[1] || "User",
      email: `${managerName.toLowerCase().replace(" ", ".")}@company.com`,
      phone: "+1 (555) 123-4567",
      profilePic: "https://api.dicebear.com/7.x/avataaars/svg?seed=Manager",
  ...
  const handleCancel = () => {
    // Reset to the saved profile data
    const savedProfile = localStorage.getItem('managerProfile');
    if (savedProfile) {
